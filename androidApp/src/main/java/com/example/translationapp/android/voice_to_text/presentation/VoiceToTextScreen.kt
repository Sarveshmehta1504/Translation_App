package com.example.translationapp.android.voice_to_text.presentation
...
import com.example.translationapp.android.voice_to_text.presentation.components.VoiceRecorderDisplay
import com.example.translationapp.core.presentation.Colors.LightBlue
import com.example.translationapp.voice_to_text.presentation.DisplayState
import com.example.translationapp.voice_to_text.presentation.VoiceToTextEvent
import com.example.translationapp.voice_to_text.presentation.VoiceToTextState
    ...
    androidx.compose.material.Scaffold(
        ...
        Column (
            ...
            Column (
                ...
                AnimatedContent(targetState = state.displayState) { displayState ->
                    when(displayState){
                        DisplayState.WAITING_IN_TALK -> {
                            Text(
                                text = stringResource(R.string.start_taking),
